...
const HeroSection = () => {
  ...
  const handleGetStarted = () => {
    if (isConnected) {
      // If connected, go to explore page or profile
      router.push('/explore');
    } else {
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-prose">
              SkillLoop connects you with peers for meaningful learning sessions. 
              Schedule sessions, commit with tokens, and earn on-chain NFT certificates.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              {[
                { icon: <Users className="h-5 w-5 text-chart-1" />, label: "Connect with peers", value: "500+ Users" },
                { icon: <Shield className="h-5 w-5 text-chart-2" />, label: "Secure escrow", value: "100% Safe" },
                { icon: <Award className="h-5 w-5 text-chart-4" />, label: "Earn NFTs", value: "Proof-of-learning" },
              ].map((stat, index) => (
            ...
            <div className="relative rounded-2xl border bg-card shadow-xl overflow-hidden aspect-[4/3] w-full max-w-md">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                <div className="text-white space-y-2">
                  ...
                  <p className="text-sm opacity-90">Learn directly from experts in your field</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -left-12 -bottom-8 rounded-xl border bg-card p-4 shadow-lg hidden lg:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">0.1 ETH locked</p>
                </div>
              </div>
            </div>
          </motion.div>
